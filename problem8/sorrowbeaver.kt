...
- 2번은 컴파일이 (실패) 한다. 왜냐하면 [ String은 Number?의 하위 타입이 아니기 때문이다. ]
- 3번은 컴파일이 (성공) 한다. 왜냐하면 [ Int?는 Number?의 하위타입이기 대문이다. ]
- 4번은 컴파일이 (성공/실패) 한다. 왜냐하면 [ String?은 Number?의 하위타입이 아니기 때문이다. ]
- 5번은 컴파일이 (성공) 한다. 왜냐하면 [ null 은 Number?의 하위 타입이기 때문이다. ]
*/
...
fun main(args: Array<String>) {
  ...
  // 따라서 기저 타입인 ItemConsumer, ItemProducer 가 같아도, 타입 인자가 다르면 [ 상하위 타입이 성립하지 않는디ㅏ. ]
  // (무공변성)을 만족하기 위해서는,
